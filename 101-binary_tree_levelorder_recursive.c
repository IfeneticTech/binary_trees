...
/**
 * levels_rec - a function that calls func on all nodes at each level.
...
/**
 * append - function that adds a new node at the end of a linkedlist
...
/**
 * free_list - function that frees all the nodes in a linked list
